...
$(document).ready(function () {
  ...
  */
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return fetch(urlTemplate).then(function (response) {
      ...
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return fetch(urlData).then(function (response) {
  ...
  function setLocationSelectList(arrStreetLocation, arrMetroLocation) {
    ...
    var tempValue; // Значение, которое будет записываться в "tempOption"
  ...
  function showResult(fRawData, fTemplateTableRow, fFilterObject) {
    ...
    months.forEach(function (currentMonth) {
      ...
      templateWrapperContent = document.importNode(templateWrapper.content, true); // ищем элемент заголовка во фрагменте  <template>
      ...
      outerContainer.append(templateWrapperContent); // Рендерим таблицу для текущего месяца (currentMonth) при помощи библиотеки Handlebars
  ...
  regeneratorRuntime.mark(function _callee() {
    var templateTableRow, rawData, filterObject, arrUniqueOffices, arrRelatedMetroToOffices;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            arrUniqueOffices = getUniqueData(rawData, 'Office.ShortName', false); // Получаем связанное метро к каждой улице

            arrRelatedMetroToOffices = getMetroStations(rawData, arrUniqueOffices); // Заполняем раскрывающийся список 

            setLocationSelectList(arrUniqueOffices, arrRelatedMetroToOffices); // Первый показ данных с расписанием
...
},{"@babel/polyfill":2,"whatwg-fetch":309}],2:[function(require,module,exports){
"use strict";
