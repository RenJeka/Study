...
const tableName = 'nodejs_lesson_9_2';
const tableColumns = {
    id: 'id',
    name: 'name',
...
const createTableQuery = `CREATE TABLE ?? (
                        ...
                        ) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='table for Nodejs lesson 9 (HW2) from ITVDN';`
